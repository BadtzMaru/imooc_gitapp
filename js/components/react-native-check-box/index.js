...
import { StyleSheet, View, Image, Text, TouchableOpacity, ViewPropTypes as RNViewPropTypes } from 'react-native';
...
export default class CheckBox extends Component {
	...
	render() {
		return (
			<TouchableOpacity style={this.props.style} onPress={() => this.onClick()} underlayColor='transparent' disabled={this.props.disabled}>
